        ...
        suggestions: {
            ...
            items: {
                ...
                properties: {
                    ...
                    reason:     { type: Type.STRING, description: "Why perfect for this person" },
                    priceRange: { type: Type.STRING, description: "Approximate price range" },
                    category:   { type: Type.STRING, description: "e.g. electronics, books, fashion" },
                },
